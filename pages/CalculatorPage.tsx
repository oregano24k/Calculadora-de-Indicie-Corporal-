...
const CalculatorPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-100 dark:bg-slate-900 flex items-center justify-center p-4 font-sans transition-colors duration-500 py-24">
      <main className="w-full max-w-4xl mx-auto">
        ...
        <footer className="text-center mt-6 pb-6">
